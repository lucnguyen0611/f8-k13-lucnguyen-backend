...
@Module({
  imports: [DatabaseModule, ClassModule, SubjectModule, UserModule, ClassUserModule, ExamGroupModule, ExamModule, QuestionModule, AnswerModule, ExamResultModule, TopicModule, FileModule, JobModule],
  controllers: [],
